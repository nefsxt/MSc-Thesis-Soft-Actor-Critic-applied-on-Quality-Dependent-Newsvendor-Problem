This project is provided for portfolio purposes only. By accessing this repository, you agree to the following terms:

No Use Without Permission: No part of this repository, including code, documentation, or assets, may be used, reproduced, modified, or distributed in any form without explicit written permission from the project owner.
